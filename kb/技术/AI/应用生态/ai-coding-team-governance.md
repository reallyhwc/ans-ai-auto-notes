...
> 关联: [Harness Engineering](./harness-engineering.md) — AI 时代工程范式 | [AI 编程递进路径](./ai-coding-levels.md) — 6 个 Level | [AI 编程 Agent 工具](./ai-coding-agents.md) — 三方工具对比
...
> 关联: [AI 编程 Agent 工具](./ai-coding-agents.md) — Claude Code/Codex CLI/DeepSeek-TUI
> 关联: [外部参考链接](../../../实战/技巧/外部参考链接.md) — 本文原文链接

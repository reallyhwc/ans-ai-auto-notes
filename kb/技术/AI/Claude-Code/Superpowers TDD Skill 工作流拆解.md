...
> 关联: [Agent与MCP](<../大模型/Agent 与 MCP.md>) — Skill 的定位与五者关系
> 关联: [claude-code-architecture](<./Claude Code 整体架构 & 工作流程.md>) — Claude Code 整体架构
> 关联: [harness-engineering](<./Harness Engineering：AI Agent 时代的工程范式.md>) — 约束工程三层模型

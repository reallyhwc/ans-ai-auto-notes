...
> 关联: [agent-development-practice](./agent-development-practice.md) — Spring AI Agent 开发（Java 路线）
...
Spring AI 的 [Demo A](./agent-development-practice.md) 只需要 1 行代码跑 ReAct 循环。LangChain 做同样的事需要 ~30 行——但每一行你都看得到在干什么，每一环都可以替换。

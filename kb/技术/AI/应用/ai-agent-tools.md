...
> 关联: [llm-agent-mcp](../大模型/llm-agent-mcp.md) — Agent 基础概念、MCP 协议、Function Calling 机制 | [ai-coding-tools](../AI-Coding/ai-coding-tools.md) — AI 编程 IDE 与 CLI Agent 对比 | [知识管理工具对比](../../../实战/knowledge-management-tools.md) — Obsidian vs AI 知识库方案

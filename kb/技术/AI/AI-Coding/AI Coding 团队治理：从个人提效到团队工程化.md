...
> 关联: [AI 时代开发者角色进化](./AI 时代的开发者角色进化：2026 年市场全景与职业重塑.md) — 2026 年市场全景，开发者经验如何迁移到 Agent 时代
...
> 关联: [Harness Engineering](../Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md) — AI 时代工程范式 | [AI 编程递进路径](./AI 编程的递进路径：从古法编程到多 Agent 协作.md) — 6 个 Level | [AI 编程工具](./AI 编程工具：CLI Agent 与 GUI IDE 全景对比.md) — CLI Agent + GUI IDE 全景对比
...
这也对应了 [AI 编程递进路径](./AI 编程的递进路径：从古法编程到多 Agent 协作.md) 中的 **Level 4（Skill/Workflow）→ Level 5（多 Agent 协作）**的跃迁——从个人用好 AI 到团队用好 AI。

> 关联: [Harness Engineering](../Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md) — 六个核心组件详解
> 关联: [AI 编程递进路径](./AI 编程的递进路径：从古法编程到多 Agent 协作.md) — L4 Skill → L5 多 Agent
> 关联: [AI 编程工具](./AI 编程工具：CLI Agent 与 GUI IDE 全景对比.md) — Claude Code/Codex CLI/DeepSeek-TUI + Cursor/Windsurf
> 关联: [外部参考链接](../../../实战/外部参考链接.md) — 本文原文链接

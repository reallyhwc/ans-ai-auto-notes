...
> 关联: [AI Coding 团队治理](./ai-coding-team-governance.md) — Pre-PR 机制、人机对齐方法论、31 万行重构实践
> 关联: [AI Coding 分层](./ai-coding-levels.md) — AI Coding 五个能力层级
> 关联: [Agent 开发实战](../应用/agent-development-practice.md) — 从编码视角看 Agent 开发范式
> 关联: [AI 时代开发者角色进化](./developer-role-in-ai-era.md) — 2026 年市场全景，开发者经验如何迁移

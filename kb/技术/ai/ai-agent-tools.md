...
> 关联: [llm-agent-mcp](./llm-agent-mcp.md) — Agent 基础概念、MCP 协议、Function Calling 机制 | [ai-coding-ides](./ai-coding-ides.md) — AI 编程 IDE 对比 | [知识管理工具对比](../../action/技巧/knowledge-management-tools.md) — Obsidian vs AI 知识库方案

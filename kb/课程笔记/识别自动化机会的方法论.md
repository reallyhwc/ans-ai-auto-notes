...
> 关联: [Skills 渐进式披露架构](<../技术/AI/Claude-Code/Skills 渐进式披露架构.md>) — skill 是自动化的主要载体
> 关联: [Hooks 事件全景与拦截机制](<../技术/AI/Claude-Code/Hooks 事件全景与拦截机制.md>) — hook 是机械化自动化的兜底
> 关联: [子智能体（subagents）机制与实战](../技术/AI/Claude-Code/子智能体（subagents）机制与实战.md) — subagent 是上下文隔离类自动化
> 关联: [Harness Engineering：AI Agent 时代的工程范式](<../技术/AI/Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md>) — 自动化是约束工程的"上游"

...
| # | 标题 | 作者/来源 | 日期 | 主题 | 关联笔记 |
|---|---|---|---|---|---|
| 1 | 用 Agent 评测思路管理 AI Coding —— 31 万行代码 AI 重构的实践 | 美团技术团队 | 2026-05-07 | AI Coding 工程化 / Pre-PR | [AI Coding 团队治理](<../技术/AI/AI-Coding/AI Coding 团队治理：从个人提效到团队工程化.md>) |
| 2 | 别学歪了：Harness 不是新概念，是你已经在做的事 | "先用起来" | 2026-04-16 | Harness Engineering | [Harness Engineering](<../技术/AI/Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md>) |
| 3 | 不写代码的工程师，才是 AI 时代最值钱的人 | 汉松（蚂蚁集团） | 不详 | 复利工程 / Agent 团队 | [Harness Engineering](<../技术/AI/Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md>) |
| 4 | Agent 评测与重构实践（原文链接见下） | 见各条目 | 见各条目 | AI Coding | 见各条目「关联笔记」|

> 新增条目时请同步补这张汇总表（置顶，便于一眼扫完全部来源）。
...
- **关联笔记**: [AI Coding 团队治理](<../技术/AI/AI-Coding/AI Coding 团队治理：从个人提效到团队工程化.md>)
...
- **关联笔记**: [Claude Code 进阶工作流](<../技术/AI/Claude-Code/Claude Code 进阶工作流：从能用到高效.md>)
...
- **关联笔记**: [Harness Engineering](<../技术/AI/Claude-Code/Harness Engineering：AI Agent 时代的工程范式.md>)

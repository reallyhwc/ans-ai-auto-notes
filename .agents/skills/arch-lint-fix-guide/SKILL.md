...
**注意**：title 必须与中文文件名一致（AGENTS.md 规则）。
...
### 5. AGENTS.md 目录结构与磁盘一致性

**问题**：AGENTS.md 中描述的目录结构与实际 `kb/` 目录不符。

**修复**：
- 如果是新增了分类：更新 AGENTS.md 的"知识库结构"段
- 如果是 AGENTS.md 过时：同步当前结构
...
**问题**：AGENTS.md 或 README.md 中引用的脚本/文件不存在。

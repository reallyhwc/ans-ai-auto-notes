...
// ============================================================
section('2/11 manifest.json path 实存检查');
let missingFiles = 0;
...
// ============================================================
section('3/11 timeline.json link 实存检查');
...
// ============================================================
section('4/11 INDEX.md 和 manifest.json 双向同步');
...
// ============================================================
section('5/11 timeline 磁盘 和 timeline.json 双向同步');
...
// ============================================================
section('7/11 overview.html 脚本引用完整性（防白屏）');
...
// ============================================================
section('8/11 scripts/app.js 存在性');
...
// ============================================================
section('9/11 CLAUDE.md 目录结构与磁盘一致性');
...
// ============================================================
section('10/11 kb/ md 文件 frontmatter title 检查');
let noTitle = 0;
for (const p of allPaths) {
  const abs = path.join(ROOT, p);
...
// ============================================================
section('11/11 overview.html 无内联 JS 残留');

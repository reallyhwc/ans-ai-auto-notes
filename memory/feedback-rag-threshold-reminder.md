...
提醒语：
> "知识库已有 X 篇文件，达到了之前规划的 BM25 索引建设阈值。详见 `kb/技术/AI/应用/个人知识库接入 RAG 的规划.md` §3 第一步。是否要启动？"

### 阈值 2：>80 篇 → 提醒启动 MCP Server

提醒语：
> "知识库已有 X 篇文件，接近全量读入 context 的极限。之前规划了 MCP Server 方案，详见 `kb/技术/AI/应用/个人知识库接入 RAG 的规划.md` §3 第二步。是否要启动？"

## 相关文件

- 规划文档：`kb/技术/AI/应用/个人知识库接入 RAG 的规划.md`

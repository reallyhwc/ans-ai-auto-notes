...
**Why:** 2026-05-26 发生严重事故——向用户说"已沉淀到 kb/技术/AI/应用/LangChain Agent 开发指南：是什么、怎么用、与 Spring AI 对比.md"，但实际上没有执行 Write 工具创建该文件。用户随后发现 overview.html 上看不到这篇笔记。这是一个信任破坏级别的错误。
